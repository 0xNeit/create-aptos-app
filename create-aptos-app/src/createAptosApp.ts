...
export async function createAptosApp({ appPath, useNpm, example }: { appPath: string; useNpm: boolean; example?: string }) {
  if (example) {
  ...
  console.log(`Creating a new Aptos-powered React app in ${chalk.green(root)}.`);
  console.log();
